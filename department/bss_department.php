...
include("../connect.php");
 ...
 $data = "SELECT * FROM bs_f_request INNER JOIN users ON users.id = bs_f_request.users_id 
 INNER JOIN company ON bs_f_request.company_id = company.id WHERE hod_prove = 'none'";
$total_f = mysqli_query($conn, $data);


$date = "SELECT COUNT(*) AS total_u FROM bs_f_request WHERE hod_prove = 'none' ";
...
<header class="head">
    ...
    <center>
        <h1 class="hd">OITS BS's DEPARTMENT</h1>
        <div  id="notification" >
      ...
      <table>
        ...
        <?php
          ...
          echo "<td>".$all['hod_prove']."</td>";
                   ...
                   echo "<td><a href=\"department_action.php?sign_bs=$all[bs_id]\" onClick=\"return confirm('Approving this Application will Automatically Attach your Email to the Request, Do you want to continue ?')\">Approve</a></td>";
                  }
                  ?>
                  </table>
                </div>
